...
const ArticlePage = ({ params }) => {
  ...
  const shareOnFacebook = () => {
    ...
    console.log('Sharing on Facebook:', shareUrl); // Log the URL
  ...
  const shareOnTwitter = () => {
    ...
    console.log('Sharing on Twitter:', shareUrl); // Log the URL
    window.open(shareUrl, '_blank');
  };
  ...
  return (
    <section className="w-full mx-auto mt-10 px-4 lg:px-0 overflow-x-hidden relative">
      <div className="w-full lg:w-[54%] mx-auto bg-opacity-90 p-5 rounded-lg">
        ...
        <div
          className="text-[#474F7A] text-wrap w-full font-noto-sans-georgian text-[14px] sm:text-[16px] font-normal text-justify leading-[30px] sm:leading-[35px] tracking-[0.32px]"
