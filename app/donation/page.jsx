      ...
      <section className="block lg:hidden">
        ...
        <div className="W-full flex flex-col gap-[60px]">
          <div className="flex pr-1 pl-4 text-balance flex-col gap-[20px] w-full">
            <div className=" flex gap-[24px] text-balance flex-col mt-5 text-[#474F7A] text-[16px] font-normal ">
              ...
              <p className="w-11/12">
                ...
                კორპორაციების, პარტიების დღის წესრიგით იმართება, "მაუწყებლის"
                არსებობა და განვითარება ბევრი ადამიანისთვისაა მნიშვნელოვანი
              </p>
            </div>
            {/* <div className="">
              <Image
          ...
          <div className="flex  w-11/12  pl-4 flex-col gap-[24px]">
            <h1 className="text-[#474F7A] pr-4 text-[32px] font-extrabold">
