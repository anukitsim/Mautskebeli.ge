      ...
      <div className="W-7/12 flex flex-col gap-[60px]">
        ...
        <div className="flex gap-[20px] w-full">
          <div className="w-6/12 flex gap-[24px] flex-col text-[#474F7A] text-[16px] font-normal ">
            <p>
              "მაუწყებელი" უარს ამბობს თავის პლატფორმებზე განათავსოს კომერციული
              რეკლამები, ვინაიდან გვჯერა, რომ მედია პოლიტიკურ ინტერესებთან ერთად
              თავისუფალი უნდა იყოს კომერციული ინტერესებისგანაც
            </p>
            <p>
              გვჯერა, რომ მაშინ, როდესაც მედიასივრცე ოლიგარქების, კორპორაციების,
              პარტიების დღის წესრიგით იმართება, "მაუწყებლის" არსებობა და
              განვითარება ბევრი ადამიანისთვისაა მნიშვნელოვანი
            </p>
          </div>
        ...
        <div className="flex flex-col gap-[24px]">
          ...
          <p className="text-[#474F7A] text-[16px] font-normal ">
            იმისთვის, რომ უკეთ შევძლოთ მომავლის დაგეგმვა, სასურველია თუ თქვენი
            დახმარების ფორმა ყოველთვიური იქნება. მინიმალური მხარდაჭერაც კი
            ჩვენთვის უმნიშვნელოვანესია
          </p>
          <p className="text-[#474F7A] text-[16px] font-normal ">
