...
export default function NewsDetailClient() {
  ...
  const openShare = (platform) => {
    ...
    const titleText = encodeURIComponent(news?.title?.rendered || news?.title || '');
  ...
  if (error) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        ...
        >
          <div className="w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-to-br from-[#AD88C6]/20 to-[#8C74B2]/20 flex items-center justify-center">
            ...
            <div className="px-6 lg:px-10 py-8 lg:py-10">
              {news.acf?.description && (
                <div 
                  ...
                  style={{ borderImage: 'linear-gradient(180deg, #AD88C6 0%, #8C74B2 100%) 1' }}
                >
