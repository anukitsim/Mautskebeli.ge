  ...
  return (
    <section className="w-full mx-auto mt-10 lg:mt-20 px-4 lg:px-0">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl lg:text-xl font-bold mb-5">{article.acf.author}</h1>
        <div className="prose prose-lg max-w-none" dangerouslySetInnerHTML={{ __html: article.acf['text'] }}></div>
      </div>
    </section>
  );
};
